...
<main>
    ...
    <div class="modal fade" id="FormModalgx" tabindex="-1" data-bs-backdrop="static" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <form id="regForm" method="POST" action="{{ route($role . '.profiles.store') }}" callbackSuccessFn="closeModal" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-12">
                                ...
                                <select name="profile_source_id" class="virtualSelect" id="profile_source_id" placeholder="Profile Source" required>
                            ...
                            <div class="col-12 col-md-12">
                                ...
                                <input type="text" name="profile_source_comment" class="form-control" placeholder="E.g. Matrimony Profile Link, Website Enquiry ID, Reference by John, Instagram Ad, Walk-in at Delhi Office">
                                <small class="form-text text-muted">
                                    Add specific details like profile link, enquiry ID, or name of the referrer (if applicable).
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="email" name="alternative_email" class="form-control" placeholder="example@email.com">
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label">Phone Number <sup class="text-danger">*</sup></label>
                                <input type="tel" id="phone_number" name="phone_number" class="form-control" required placeholder="Enter phone number">
                                {{-- <div class="invalid-feedback">Please enter a valid phone number</div> --}}
                                <input type="hidden" name="phone_code" id="phone_code">
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label">Alternative Phone Number</label>
                                <input type="tel" id="alternative_phone_number" name="alternative_phone_number" class="form-control" placeholder="Enter alternative phone number">
                                <input type="hidden" name="alternative_phone_code" id="alternative_phone_code">
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label">Contact Person</label>
                                <input id="contact_person" type="text" name="contact_person_name" class="form-control" placeholder="Enter contact person name">
                            </div>
                            <div class="col-12 col-md-6">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select name="gender" id="gender" class="virtualSelect" placeholder="Select Gender" required>
                                    <option value="" disabled selected>Select</option>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select name="marital_status" id="marital_status" placeholder="Select Status" class="virtualSelect">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select class="virtualSelect" name="height" id="height" placeholder="Select Height">
                                    ...
                                    $usedHeights = [];
                                    @endphp
                                    @for ($cm = 122; $cm <= 213; $cm++) @php $inches=round($cm / 2.54); $feet=floor($inches / 12); $remainingInches=$inches % 12; $display="{$feet}ft {$remainingInches}in - {$cm}cm" ; $key="{$feet}ft {$remainingInches}in" ; @endphp @if (!in_array($key, $usedHeights)) <option value="{{ $display }}">{{ $display }}</option>
                                        @php
                                        $usedHeights[] = $key;
                                        @endphp
                                        @endif
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="number" id="weight" placeholder="Enter weight" name="weight" class="form-control">
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label">Body Type</label>
                                <select id="body_type" name="body_type" class="virtualSelect" placeholder="Select Body Type">
                                    <option value="" disabled hidden selected>Select</option>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select id="blood_group" name="blood_group" class="virtualSelect" placeholder="Select Blood Group">
                                    <option value="" disabled hidden selected>Select</option>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select id="health_status" name="health_status" class="virtualSelect" placeholder="Select Health Status">
                                    <option value="" disabled hidden selected>Select</option>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" id="native_place" name="native_place" class="form-control" placeholder="Enter native place">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select id="citizenship" name="citizenship" class="virtualSelect" multiple placeholder="Select Citizenship">
                                    <option value="" disabled hidden selected>Select</option>
                                </select>
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label">Country Grew up</label>
                                <select id="grow_up" name="grow_up_in[]" class="virtualSelect" multiple placeholder="Select Grow Up Location">
                                    <option value="" disabled hidden selected>Select</option>
                                </select>
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label fw-bold"><strong>Upload Govt ID</strong></label>
                                <input id="govt_id" type="file" name="government_id[]" class="form-control" accept=".jpg, .jpeg, .png, .pdf" multiple>
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label fw-bold"><strong>Upload Photo </strong><span class="text-danger">(minimum 5 photos upload)</span></label>
                                <input id="photo" type="file" name="photo[]" class="form-control" accept=".jpg, .jpeg, .png" multiple>
                            </div>
                            <div class="col-12 col-md-6">
                            ...
                            <div class="col-12 col-md-12">
                                <label class="form-label fw-bold">Write down about yourself <span class="text-muted">(at least 200 words)</span></label>
                                <textarea id="bio" name="bio" class="form-control" rows="3" placeholder="write down about your self atleast 200 words"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select id="religion" name="religion" class="virtualSelect" placeholder="Select Religion">
                                    <option value="" disabled hidden selected>Select</option>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input id="sub_caste" type="text" name="sub_caste" class="form-control" placeholder="Enter sub caste">
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label">Gotra</label>
                                <input id="gotra" type="text" name="gotra" class="form-control" placeholder="Enter gotra">
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-4">
                                ...
                                <input id="birth_time" type="time" name="birth_time" class="form-control" placeholder="Enter birth time">
                            </div>
                            <div class="col-12 col-md-4">
                                <label class="form-label">Place of Birth</label>
                                <input id="birth_place" type="text" name="birth_place" class="form-control" placeholder="Enter birth place">
                            </div>
                            <div class="col-12 col-md-4">
                                <label class="form-label">Manglik Status</label>
                                <select id="manglik" name="manglik_status" class="virtualSelect" placeholder="Select Manglik Status">
                                    <option value="" disabled hidden selected>Select</option>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                ...
                                <select id="highest_qualification" name="highest_qualification[]" class="virtualSelect" placeholder="Select Qualification" multiple>
                                    <option value="" disabled hidden selected>Select</option>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select id="education_field" name="education_field[]" class="virtualSelect" placeholder="Select Education Field" multiple>
                                    <option value="" disabled hidden selected>Select</option>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input id="college_university" type="text" name="institute_name" class="form-control" placeholder="Enter college or university name">
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label">Work Location</label>
                                <input id="work_location" type="text" name="work_location" class="form-control" placeholder="Enter work location">
                            </div>
                            <div class="col-12 col-md-6">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select id="profession" name="profession[]" class="virtualSelect" placeholder="Select Profession" multiple="">
                                    <option value="" disabled hidden selected>Select</option>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input id="business_company_name" type="text" name="business_name" class="form-control" placeholder="Enter business or company name">
                            </div>
                            <div class="col-12 col-md-6">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select id="annual_income" name="annual_income" class="virtualSelect" placeholder="Select Annual Income">
                                    <option value="" disabled hidden selected>Select</option>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select id="drinking" name="drinking_status" class="virtualSelect" placeholder="Select Drinking Status">
                                    <option value="" disabled hidden selected>Select</option>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select id="smoking" name="smoking_status" class="virtualSelect" placeholder="Select Smoking Status">
                                    <option value="" disabled hidden selected>Select</option>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                ...
                                <select id="father_occupation" name="father_occupation" class="virtualSelect" placeholder="Select Father's Occupation">
                                    <option value="" disabled hidden selected>Select</option>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select id="mother_occupation" name="mother_occupation" class="virtualSelect" placeholder="Select Mother's Occupation">
                                    <option value="" disabled hidden selected>Select</option>
                            ...
                            <div class="form-group col-md-6 mt-2 married_brothers">
                                ...
                                <select name="married_brother_count" id="married_brothers" class="form-control">
                                    ...
                                    @for ($i = 0; $i <= old('brother_count', 0); $i++) <option value="{{ $i }}">{{ $i }}</option>
                                        @endfor
                                </select>
                            </div>
                            <div class="form-group col-md-6 mt-2">
                            ...
                            <div class="form-group col-md-6 mt-2 married_sisters">
                                ...
                                <select name="married_sister_count" id="married_sisters" class="form-control">
                                    <option value="" disabled {{ old('married_sister_count') ? '' : 'selected' }}>-- Select --</option>
                                    @for ($i = 0; $i <= old('sister_count', 0); $i++) <option value="{{ $i }}" {{ old('married_sister_count') == $i ? 'selected' : '' }}>
                                        {{ $i }}</option>
                                        @endfor
                                </select>
                            </div>
                            <div class="form-group col-md-6 mt-2">
                                ...
                                <select class="virtualSelect m-2" id="family_type" name="family_type" placeholder="Select Family Type">
                                    <option value="" disabled selected>-- Select --</option>
                            ...
                            <div class="form-group col-md-6 mt-2">
                                ...
                                <select class="virtualSelect m-2" id="family_affluence" name="family_affluence" placeholder="Select Family Affluence">
                                    <option value="" disabled selected>-- Select --</option>
                            ...
                            <div class="form-group col-md-6 mt-2">
                                ...
                                <select class="virtualSelect m-2" id="family_values" name="family_values" placeholder="Select Family Values">
                                    <option value="" disabled selected>-- Select --</option>
                            ...
                            <div class="form-group col-md-12 mt-2">
                                <label class="form-label fw-bold">Write Down about your family <span class="text-muted">(at least 200 words)</span></label>
                                <textarea class="form-control" id="family_bio" name="family_bio" rows="3" placeholder="Enter family bio/intro"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                ...
                                <select class="virtualSelect m-2" name="partner[min_age]" placeholder="Select Minimum Age">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select class="virtualSelect m-2" name="partner[max_age]" placeholder="Select Maximum Age">
                                    <option value="" disabled selected>Select</option>
                                    @for ($i = 18; $i <= 100; $i++) <option value="{{ $i }}">{{ $i }}</option>
                                        @endfor
                                </select>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select class="virtualSelect" name="partner[min_height]" id="partner_min_height" placeholder="Select Height">
                                    <option value="" disabled selected hidden>Select</option>
                                    @php
                                    $usedHeights = [];
                                    @endphp
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select class="virtualSelect" name="partner[max_height]" id="partner_max_height" placeholder="Select Height">
                                    <option value="" disabled selected hidden>Select</option>
                                    @php
                                    $usedHeights = [];
                                    @endphp
                            ...
                            <div class="col-12 col-md-6">
                                <label class="form-label">Marital Status</label>
                                <select name="partner[marital_status][]" id="partner_marital_status" multiple placeholder="Select Status" class="virtualSelect">
                                    <option value="" disabled selected hidden>Select</option>
                            ...
                            <div class="col-12 col-md-6">
                                <label class="form-label">Partner Religion</label>
                                <select id="partner_religion" name="partner[partner_religion]" class="virtualSelect" multiple>
                                    <option value="" disabled hidden selected>Select</option>
                                    <option value="Open to all">Open to all</option>
                            ...
                            <div class="col-12 col-md-6">
                                <label class="form-label">Manglik Status</label>
                                <select id="partner_manglik" name="partner[manglik_status]" class="virtualSelect" multiple placeholder="Select Manglik Status">
                                    <option value="" disabled hidden selected>Select</option>
                                    <option value="Open to all">Open to all</option>
                                    @foreach (manglikOptions() as $option)
                                    <option value="{{ $option }}">{{ $option }}</option>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                ...
                                <select id="partner_country" name="partner[country]" class="virtualSelect" placeholder="Select Country">
                                    <option value="" disabled hidden selected>Select</option>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select id="partner_state" name="partner[state]" class="virtualSelect" placeholder="Select State">
                                    <option value="" disabled hidden selected>Select</option>
                                </select>
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label">City</label>
                                <select id="partner_city" name="partner[city]" class="virtualSelect" placeholder="Select City">
                                    <option value="" disabled hidden selected>Select</option>
                                </select>
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label">Citizenship</label>
                                <select id="partner_citizenship" name="partner[citizenship]" class="virtualSelect" placeholder="Select Citizenship">
                                    <option value="" disabled hidden selected>Select</option>
                                </select>
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label">Country Grew up</label>
                                <select id="partner_grow_up" name="partner[grow_up_in][]" class="virtualSelect" multiple placeholder="Select Grow Up Location">
                                    <option value="" disabled hidden selected>Select</option>
                                     <option value="Open to All">Open to All</option>
                                </select>
                            </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                <label class="form-label">Highest Qualification</label>
                                <select id="partner_highest_qualification" name="partner[highest_qualification]" class="virtualSelect" placeholder="Select Highest Qualification" multiple>
                                    <option value="" disabled hidden selected>Select</option>
                                                                        <option value="Open to All">Open to All</option>
                            ...
                            <div class="col-12 col-md-6">
                                <label class="form-label">Education Field</label>
                                <select id="partner_education_field" name="partner[education_field]" class="virtualSelect" placeholder="Select Education Field" multiple>
                                    <option value="" disabled hidden selected>Select</option>
                                     <option value="Open to All">Open to All</option>
                                    @foreach (getEducationFieldOptions() as $option)
                                    <option value="{{ $option }}">{{ $option }}</option>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select id="partner_working_with" name="partner[employer_name]" class="virtualSelect" multiple>
                                    <option value="" disabled selected>Select work type</option>
                                    <option value="Open to All">Open to All</option>
                                    <option value="Private Company">Private Company</option>
                                    <option value="Government / Public Sector">Government / Public Sector</option>
                            ...
                            <div class="col-12 col-md-6">
                                <label class="form-label">Profession</label>
                                <select id="partner_profession" name="partner[profession]" class="virtualSelect" placeholder="Select Profession" multiple="">
                                    <option value="" disabled hidden selected>Select</option>
                                    <option value="Open to All">Open to All</option>
                                    @foreach (getOccupationOptions() as $option)
                                    <option value="{{ $option }}">{{ $option }}</option>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select id="partner_annual_income" name="partner[annual_income]" class="virtualSelect" placeholder="Select Annual Income">
                                    <option value="" disabled hidden selected>Select</option>
                                    <option value="Open to All">Open to All</option>
                                    @foreach (getIncomeRanges() as $option)
                                    <option value="{{ $option }}">{{ $option }}</option>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                <label class="form-label">Diet</label>
                                <select id="partner_diet" name="partner[diet]" class="virtualSelect" placeholder="Select Diet" multiple>
                                    <option value="Open to all">Open to all</option>
                            ...
                            <div class="col-12 col-md-6">
                                <label class="form-label">Drinking</label>
                                <select id="partner_drinking" name="partner[drinking_status]" class="virtualSelect" placeholder="Select Drinking Status" multiple>
                                    <option value="" disabled hidden selected>Select</option>
                                    <option value="Open to all">Open to all</option>
                            ...
                            <div class="col-12 col-md-6">
                                <label class="form-label">Smoking</label>
                                <select id="partner_smoking" name="partner[smoking_status]" class="virtualSelect" placeholder="Select Smoking Status" multiple>
                                    <option value="" disabled hidden selected>Select</option>
                                    <option value="Open to all">Open to all</option>
                            ...
                            <div class="col-12 col-md-12">
                                ...
                                <textarea id="partner_about" name="partner[about]" class="form-control" placeholder="Write about your partner preference" rows="3"></textarea>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        altPhoneInput.addEventListener('countrychange', function() {
            document.querySelector('#alternative_phone_code').value = '+' + altPhoneIti
        ...
        document.querySelector('#alternative_phone_code').value = '+' + altPhoneIti.getSelectedCountryData()
            .dialCode;
        ...
        document.querySelector('#religion').addEventListener('change', async function() {
            ...
            try {
                const response = await makeHttpRequest("{{ route($role . '.profiles.showCasts') }}", "POST", formData, true);
