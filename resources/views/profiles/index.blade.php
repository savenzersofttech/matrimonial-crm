                        ...
                        <form id="regForm" method="POST" action="{{ route($role . '.profiles.store') }}"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input id="contact_person" type="text" name="contact_person_name"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <select class="virtualSelect" name="height" id="height"
                                        ...
                                        @for ($cm = 122; $cm <= 213; $cm++)
                                            @php
                                                ...
                                                $key = "{$feet}ft {$remainingInches}in";
                                            @endphp @if (!in_array($key, $usedHeights))
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="country" name="country" class="virtualSelect"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="state" name="state" class="virtualSelect"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="city" name="city" class="virtualSelect"
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <select id="citizenship" name="citizenship[]" class="virtualSelect" multiple
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <select id="grow_up" name="grow_up_in[]" class="virtualSelect" multiple
...
.preview-container img {
    ...
    .delete-icon {
        ...
        z-index: 1;
                                ...
                                <div class="col-12 col-md-12">
                                    <label class="form-label fw-bold">Write down about yourself <span
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <select id="caste" name="caste" class="virtualSelect"
    ...
    @endforeach-->
                            ...
                            <div class="row g-3">
                                <div class="col-12 col-md-6">
                                    ...
                                    <select id="highest_qualification" name="highest_qualification[]"
                                        class="virtualSelect" placeholder="Select Qualification" multiple>
                                        <option value="" disabled hidden selected>Select</option>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input id="college_university" type="text" name="institute_name"
                                        class="form-control" placeholder="Enter college or university name">
                                </div>
                                <div class="col-12 col-md-6">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input id="business_company_name" type="text" name="business_name"
                                        class="form-control" placeholder="Enter business or company name">
                                </div>
                                <div class="col-12 col-md-6">
                            ...
                            <div class="row g-3">
                                <div class="col-12 col-md-6">
                                    ...
                                    <select id="diet" name="diet" class="virtualSelect"
    ...
    @endforeach-->
                                ...
                                <div class="col-12 col-md-6">
                                    <label class="form-label">Partner Caste</label>
                                    <select id="partner_caste" name="partner[partner_caste]" class="virtualSelect"
                                        multiple>
                                        <option value="" disabled hidden selected>Select</option>
                                        <option value="Open to all">Open to all</option>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6">
                                    <label class="form-label">Country Grew up</label>
                                    <select id="partner_grow_up" name="partner[grow_up_in][]" class="virtualSelect"
                                        multiple placeholder="Select Grow Up Location">
                                        <option value="" disabled hidden selected>Select</option>
                                        <option value="Open to All">Open to All</option>
                                    </select>
                                </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6">
                                    <label class="form-label">Designation</label>
                                    <input id="partner_designation" type="text" name="partner[designation]"
                                        class="form-control" placeholder="Enter designation">
                                </div>
                                <div class="col-12 col-md-6">
                                    <label class="form-label">Annual Income</label>
                                    <select id="partner_annual_income" name="partner[annual_income]"
                                        class="virtualSelect" placeholder="Select Annual Income" multiple >
                                        <option value="" disabled hidden selected>Select</option>
                                        <option value="Open to All">Open to All</option>
                                        @foreach (getIncomeRanges() as $option)
                                            <option value="{{ $option }}">{{ $option }}</option>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            const casteOptions = {
                Hindu: ["Agarwal", "Brahmin", "Kayastha", "Khatri", "Maratha", "Rajput", "Yadav", "Nair",
                    "Vysya"
                ],
    ...
    render: function(data, type, row) {
        ...
        return `
            <div style="display: flex; align-items: center; gap: 10px;">
                <img src="${imageUrl}" alt="Photo" width="40" height="40"
