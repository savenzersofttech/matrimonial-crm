    ...
    <main>
        ...
        <div class="modal fade" id="FormModalgx" tabindex="-1" aria-labelledby="FormModalgxLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form action="{{ route('services.payments.store') }}" id="regForm" callbackSuccessFn="closeModal"
                    method="POST">
                    @csrf
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="virtualSelect after-parent" id="profile_id" name="profile_id"
                                    placeholder="Select Client" required>
                                    {{-- <option value="">Select Prospect</option> --}}
                                    @foreach ($profiles as $profile)
                                        <option value="{{ $profile->id }}"
                                            @if (old('profile_id') == $profile->id) selected @endif>
                                            {{ $profile->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="plan" class="form-control after-parent" name="plan"
                                    placeholder="Select Plan" required>
                                    <option value="">Select Plan</option>
                                    @foreach ($packages as $pkg)
                                        <option data-price="{{ $pkg->price }}" value="{{ $pkg->id }}">
                                            {{ $pkg->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="price" type="number" value="{{ old('price') }}" name="price"
                                    class="num  after-parent form-control" required>
                            </div>

                            <div class="row">
                                <div class="col-6 mb-3">
                                <label for="start_date" class="form-label">Start Date</label>
                                <input type="date" class="form-control after-parent" id="start_date"
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="date" class="form-control after-parent" id="end_date"
                                    name="end_date" value="{{ old('end_date', now()->addDays(30)->format('Y-m-d')) }}"
                                    required>
                            </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="discount" class="form-control after-parent" name="discount"
